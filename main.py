...
def uploadfile():
    if (session.get('username')):
        ...
        if request.method == 'POST':
            ...
            if not os.path.exists(os.getcwd() + '\\site\\wwwroot\\static\\studymaterial'):
                os.makedirs(os.getcwd() + '\\site\\wwwroot\\static\\studymaterial')
            ...
            for i in info.getlist('stream'):
                ...
                file.save(os.getcwd() + '\\site\\wwwroot\\static\\studymaterial' + secure_filename(file.filename))
